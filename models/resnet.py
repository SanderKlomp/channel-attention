...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 rclb_layer=None, layer_idx=1, is_ge=False):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, input_channels=3, num_classes=1000, recalibration_type=None):
        ...
        if recalibration_type == None:
            ...
            self.rclb_layer = rclb_layer
        elif recalibration_type == 'meanrew':
            from .recalibration_modules import MeanReweightLayer as rclb_layer
            self.rclb_layer = rclb_layer
        elif recalibration_type == 'multise':
            from .recalibration_modules import MultiSELayer as rclb_layer
            self.rclb_layer = rclb_layer
        elif recalibration_type == 'multise3':
            from .recalibration_modules import Multi3SELayer as rclb_layer
            self.rclb_layer = rclb_layer
        elif recalibration_type == 'multisrm':
            from .recalibration_modules import MultiSRMLayer as rclb_layer
            self.rclb_layer = rclb_layer
        elif recalibration_type == 'na':
            from .recalibration_modules import NALayer as rclb_layer
            self.rclb_layer = rclb_layer
        elif recalibration_type == 'eca':
            from .recalibration_modules import ECALayer as rclb_layer
            self.rclb_layer = rclb_layer
        else:
